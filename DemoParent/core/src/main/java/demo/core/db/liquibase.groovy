//package demo.core.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "demo/core/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType,["com/hand/hap","demo/core"] ,["table", "data", "patch"])
